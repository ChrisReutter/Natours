...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2hyaXM4MiIsImEiOiJja2ZrM21ubW0wNXo0MnZuZGdtY2ptdjRtIn0.IjLufh-zXKFHVkGOf7T5Lg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/chris82/ckfolxy1s08eh19nqm2rd5ld1' // scrollZoom: false
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://localhost:3000/api/v1/users/logout' // url: '/api/v1/users/logout'
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? // 'http://localhost:3000/api/v1/users/updateMyPassword' :
...
var stripe = Stripe('pk_test_51HBpMuGlszH4RPz6RZX97lYwsWXhnTGEZ08m0AhEqjvPWGsovTud7xCWjfZ0rZEpPDQNHZ7vEd1kMzBqfrgB63XN00zqLUxGWN');
